...
comment_no number(4) Primary key, --댓글번호
post_no number(4) not null, --게시글번호
mem_no varchar2(20) not null, --댓글쓴회원번호
comment_Text varchar(100),
comment_level int default 0 not null, --모댓글이면 0, 답글이면 1
