        ...
        <div class="content">
            <div class="login_wrap">
                ...
                <form id="frmNIDLogin" name="frmNIDLogin" target="_top" AUTOCOMPLETE="off"
                    ...
                    <input type="hidden" name="dynamicKey" id="dynamicKey" value="7ODTFZncYpM-hAWnzWvEceklbL2KViHp2xu1xnMN-H2wMkiPCoTdH1dLl765H0TZ7UmETNnvZOIpfRbXCKcCbMRlRVHNZFAFcOax7-UMihg">
